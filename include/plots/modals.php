...
\">
    ...
    \">
      ...
      <div style=\"display:flex; flex-direction:column; gap:4px;\">
        ...
        <button id=\"zoomExcludeOutliersBtn\" style=\"height:34px; padding:0 12px; font-size:12px; cursor:pointer; background:#8e44ad; color:white; border:none; border-radius:6px; font-weight:700; white-space:nowrap; flex-shrink:0; text-align:center;\">Exclude Outliers</button>
