...
\">
    ...
    \">
      ...
      <div style=\"display:flex; flex-direction:column; gap:4px;\">
        ...
        <button id=\"resetZoomBtn\" style=\"padding:8px 12px; font-size:12px; cursor:pointer; background:#8e44ad; color:white; border:none; border-radius:6px; font-weight:700; white-space:nowrap; flex-shrink:0;\">Reset</button>
